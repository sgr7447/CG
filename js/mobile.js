class Mobile extends THREE.Object3D{
    ...
    constructor(x, y, z) {
        ...
        var arm24_len = 15;
        var arm24 = new Cylinder(arm22, arm22.x, arm22.y - arm22_len*Math.cos(Math.PI/4)/2 - arm24_len*Math.cos(Math.PI/4)/2, z, 1/4, arm24_len, armsRadius, armsColor);
        var arm25_len = 15;
        var arm25 = new Cylinder(arm22, arm22.x - arm24_len*Math.sin(Math.PI/4), arm22.y - arm22_len*Math.cos(Math.PI/4)/2 - arm25_len*Math.cos(Math.PI/4)/2, z, -1/4, arm25_len, armsRadius, armsColor);
        ...
        var shape_len = 7;
        var shape_radius = 5;
        var shape5 = new Cylinder(arm25, arm25.x - arm25_len*Math.sin(Math.PI/4)/2, arm25.y - arm25_len*Math.cos(Math.PI/4)/2 - shape_radius, z, 1/2, shape_len, shape_radius, 0x07EEAC);

        shape_len = 5;
        var shape_radius = 5;
        var shape6 = new Cylinder(arm24, arm24.x + arm24_len*Math.sin(Math.PI/4)/2, arm24.y - arm24_len*Math.cos(Math.PI/4)/2 - shape_len/2, z, 0, shape_len, shape_radius, 0xFF6100);
