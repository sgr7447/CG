class Mobile extends THREE.Object3D{
    ...
    constructor(x, y, z) {
        ...
        var arm6 = new Cylinder(mobileTopLayer, arm5.position.x, arm5.position.y  - arm5.len/2, z, -1/4, 12, armsRadius, armsColor);
        var arm7 = new Cylinder(mobileTopLayer, arm5.position.x, arm5.position.y - arm5.len/2 , z, 1/4, 12, armsRadius, armsColor);
        ...
        var arm15 = new Cylinder(mobileMiddleLayer, arm4.position.x - arm13.len/2, arm13.position.y , z, 0, 5, armsRadius, armsColor);
